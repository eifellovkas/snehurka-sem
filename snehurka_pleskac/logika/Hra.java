 ...
 *
 *@author     Michael Kolling, Lubos Pavlicek, Jarmila Pavlickova, Václav Pleskač
...
public class Hra implements IHra {
    ...
    public Hra() {
        ...
        platnePrikazy.vlozPrikaz(new PrikazSeber(herniPlan, kabelka));
        platnePrikazy.vlozPrikaz(new PrikazZahod(herniPlan, kabelka));
     ...
     public String zpracujPrikaz(String radek) {
        ...
        if (platnePrikazy.jePlatnyPrikaz(slovoPrikazu)) {
            ...
            if(herniPlan.isVyhra()){
                textKVypsani = "postavy: Šmudla\n" + "Ha! Mám tě! Vyhrála jsem :)";
                konecHry = true;
            }
