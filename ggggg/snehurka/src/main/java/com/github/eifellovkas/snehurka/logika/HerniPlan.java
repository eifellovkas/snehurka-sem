...
public class HerniPlan extends Observable{
    ...
    //vytvářejí se věci a vkládají se do jednotlivých prostor
     Vec kristalova_koule = new Vec ("kristalova_koule", false, "../ui/zdroje/kristalova_koule.jpg");
     Vec kouzelne_zrcadlo = new Vec ("kouzelne_zrcadlo", false, "../ui/zdroje/kouzelne_zrcadlo.jpg");
     Vec koste = new Vec ("koste", true, "../ui/zdroje/koste.png");
     Vec klic_rezavy = new Vec ("rezavy_klic", true, "../ui/zdroje/rezavy_klic.png");//klíč k prázdné komnatě č.1
     Vec klic_leskly = new Vec ("leskly_klic", true, "../ui/zdroje/leskly_klic.png");//klíč k princově komnatě
     Vec stul = new Vec("stul", false, "../ui/zdroje/stul.png");
     Vec zrcadlo = new Vec("zrcadlo", false, "../ui/zdroje/zrcadlo.jpg");
     Vec pochoden = new Vec("pochoden", true, "../ui/zdroje/pochoden.png");
     Vec zamcena_skrin = new Vec("zamcena_skrin", false, "../ui/zdroje/zamcena_skrin.png");
