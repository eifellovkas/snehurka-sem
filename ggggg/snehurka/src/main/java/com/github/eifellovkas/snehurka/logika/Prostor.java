...
public class Prostor {
    private Map<String, Postava> seznamPostav; //pro dalsi upravy hry,napr.vice trpasliku
    public String nazev;
     ...
     */
    private String popisVychodu() { //v podstate seznam vychodu
    ...
    /*
     * Getters and setters pro souřadnice, umožňují přístup k hodnotám souřadnic a jejich nastavení.
     * */
    public double getX() {
		return x;
	}
